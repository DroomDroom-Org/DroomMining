    ...
    <div
      ...
      className={cn(
        "rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 ease-in-out",
        {
          ...
          "hover:shadow-[0_0_15px_rgba(var(--primary)/0.3)] dark:hover:shadow-[0_0_15px_rgba(var(--primary)/0.15)]": hoverEffect === "glow",
          "hover:border-primary/50": hoverEffect === "border",
          "hover:shadow-lg dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)]": hoverEffect === "shadow",
        },
        className
      )}
      {...props}

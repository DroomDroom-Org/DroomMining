...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://bucket.droomdroom.online/eventbucket/1763145337438-Mining-Calculator-Zcash.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Calculate mining profitability instantly with accurate estimates for Zcash (ZEC), helping you plan smarter and optimize returns.",
    images: [
      "https://bucket.droomdroom.online/eventbucket/1763145337438-Mining-Calculator-Zcash.png",
    ],
  },

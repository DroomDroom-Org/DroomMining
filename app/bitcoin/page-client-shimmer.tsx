...
export default function BitcoinHomePageClientShimmer() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            ...
            <Button disabled size="lg" className="bg-bitcoin/70">
        ...
        {[
          { title: "Bitcoin Difficulty", icon: <Gauge className="h-5 w-5" /> },
          { title: "Bitcoin Hashrate", icon: <Hash className="h-5 w-5" /> },
          { title: "Bitcoin Price Chart", icon: <TrendingUp className="h-5 w-5" /> },
        ].map((chart, index) => (

...
export default function DogecoinHomePageClientShimmer() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            ...
            <Button disabled size="lg" className="bg-dogecoin/70">
        ...
        {[
          { title: "Dogecoin Difficulty", icon: <Gauge className="h-5 w-5" /> },
          { title: "Dogecoin Hashrate", icon: <Hash className="h-5 w-5" /> },
          { title: "Dogecoin Price Chart", icon: <TrendingUp className="h-5 w-5" /> },
        ].map((chart, index) => (

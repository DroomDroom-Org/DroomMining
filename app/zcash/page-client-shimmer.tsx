...
export default function ZcashHomePageClientShimmer() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            ...
            <Button disabled size="lg" className="bg-zcash/70">
        ...
        {[
          { title: "Zcash Difficulty", icon: <Gauge className="h-5 w-5" /> },
          { title: "Zcash Hashrate", icon: <Hash className="h-5 w-5" /> },
          { title: "Zcash Price Chart", icon: <TrendingUp className="h-5 w-5" /> },
        ].map((chart, index) => (
